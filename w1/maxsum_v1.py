...
innermost loop: sum up all values from i to j+1, when i=0 & j=0, result = sum of range 0->0+1 which is first index, then i=0,j=1, repeat till middle loop is finished
